...
export const DonateCard = () => {
  ...
  const dayFromMyCloudAI = useMemo(() => {
    const now = dayjs()
                ...
                <div className="flex w-full flex-col justify-center gap-4 bg-white px-2 pb-4 pt-5 dark:bg-gray-800 dark:text-gray-300">
                  ...
                  <div className="flex w-full flex-col gap-4 px-4">
                    ...
                    <p className="mx-auto px-4 indent-4 font-bold">
                      MyCloudAI Learner 坚持 <span className="font-medium ">开源、无广告、无商业化</span> 已经
                      <HighlightedText className="text-indigo-500"> {dayFromMyCloudAI} </HighlightedText>天。
                    </p>
                    <p className="mx-auto px-4 indent-4">
                      随着越来越多的同学加入，服务器和维护成本也在不断增长，
                      <span className="font-semibold text-indigo-600 dark:text-indigo-400">
                        目前项目的运营成本仍由开发者个人承担，MyCloudAI 的长期运营需要您的一份力量
                      </span>
                      。如果 MyCloudAI 对您的学习有所帮助，希望您能考虑捐赠支持我们——哪怕是一杯咖啡的金额，都能帮助 MyCloudAI
                      继续陪伴更多学习者成长。
                    </p>
                    <p className="mx-auto px-4 indent-4 ">
                      为了感谢您的慷慨，单次 50 rmb 及以上的捐赠， 我们将回赠 MyCloudAI 的定制贴纸 5 枚
