      ...
      {showPanel && (
        ...
        >
          <p className="text-sm text-gray-600 dark:text-gray-300">
            ...
            <a
              href="https://github.com/Kaiyiwing/mycloudai-learner/blob/master/docs/toBuildDict.md"
          ...
          {/* 
            <div className="rounded-lg bg-gradient-to-r from-blue-50 to-indigo-50 p-4 shadow-sm dark:from-gray-800 dark:to-gray-700">
              <h4 className="mb-3 font-semibold text-gray-900 dark:text-white">🚀 尝试 MyCloudAI Learner</h4>
              <p className="mb-3 text-sm text-gray-600 dark:text-gray-300">
                不会编程？想拥有自己的专属学习词典？操作简单，一键上传，点击即用
                <br />
                <div className="my-2"></div>
                那么，推荐您尝试由英国 DeepLearningAI 专业团队开发运营的
                <span className="mx-1 font-semibold text-blue-600 dark:text-blue-400">MyCloudAI Learner</span>
              </p>
