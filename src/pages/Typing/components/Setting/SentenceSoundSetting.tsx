...
export default function SentenceSoundSetting() {
  const [keySoundsConfig, setKeySoundsConfig] = useAtom(sentenceKeySoundsConfigAtom)
  const [hintSoundsConfig, setHintSoundsConfig] = useAtom(sentenceHintSoundsConfigAtom)

  const onToggleKeySounds = useCallback(
    (checked: boolean) => {
      setKeySoundsConfig((prev) => ({ ...prev, isOpen: checked }))
    },
    [setKeySoundsConfig],
  )
  ...
  const onToggleHintSounds = useCallback(
    (checked: boolean) => {
      setHintSoundsConfig((prev) => ({ ...prev, isOpen: checked }))
    },
    [setHintSoundsConfig],
  )
