    ...
    <div className="flex w-screen flex-col bg-white lg:mx-auto lg:max-w-7xl">
      <header className="fixed left-0 right-0 top-0 z-50 flex items-center justify-between border-b border-gray-100/50 bg-white/80 px-6 py-6 backdrop-blur-xl lg:px-12">
        <div className="flex items-center">
          <img src={logo} className="mr-4 h-10 w-10 lg:h-12 lg:w-12" alt="MyCloudAI Learner Logo" />
          <div className="flex flex-col">
            <h1 className="text-lg font-semibold tracking-tight text-indigo-500 lg:text-xl">MyCloudAI Learner</h1>
            <span className="text-xs font-normal text-gray-500">官方网站</span>
          </div>
        </div>
        <a
          href="https://www.mycloudai.org/language-learner/"
          target="_blank"
        ...
        <div className="mx-auto max-w-7xl">
          <ol className="flex items-center space-x-2 text-sm text-gray-500" itemScope itemType="https://schema.org/BreadcrumbList">
            <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
              <a href="https://www.mycloudai.org/language-learner/" className="transition-colors hover:text-indigo-600" itemProp="item">
      ...
      <main role="main">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-gray-100 bg-white p-2 shadow-2xl">
            <div className="overflow-hidden rounded-2xl bg-white">
              ...
              >
                <img
                  src={hotImg}
                  alt="MyCloudAI Learner 英语学习软件热门词库界面 - CET 四六级雅思托福词汇在线练习"
                  className="w-full flex-shrink-0"
                />
                <img
                  src={directoryImg}
                  alt="MyCloudAI Learner 免费英语学习软件词库目录 - 支持程序员技术英语学习"
                  className="w-full flex-shrink-0"
                />
                <img
                  src={indexImg}
                  alt="MyCloudAI Learner 英语打字练习软件主界面 - 在线英语单词记忆训练"
                  className="w-full flex-shrink-0"
                />
                <img
                  src={hotImg}
        ...
        <section className="mt-24 bg-gray-50/30 px-6 py-24 lg:mt-32 lg:px-24" itemScope itemType="https://schema.org/Product">
          <div className="mx-auto max-w-7xl">
            <meta itemProp="name" content="MyCloudAI Learner" />
            <meta itemProp="description" content="为键盘工作者设计的英语学习软件，结合打字练习与单词记忆" />
            <meta itemProp="brand" content="MyCloudAI Learner" />
            ...
            <div itemProp="offers" itemScope itemType="https://schema.org/Offer">
              ...
              <meta itemProp="url" content="https://www.mycloudai.org/language-learner/" />
            </div>
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-12">
              ...
              <div className="mt-16 flex h-[14rem] items-center justify-center rounded-3xl border border-gray-200 bg-white p-8 shadow-2xl lg:mt-0 lg:h-auto lg:p-12">
                <img
                  ...
                  alt={`MyCloudAI Learner ${detail[activeIndex].title} 功能展示 - 英语学习软件特色功能截图`}
                />
              </div>
            </div>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-16 text-center">
              ...
              <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                ...
                <a
                  href="https://marketplace.visualstudio.com/items?itemName=Kaiyi.mycloudai-learner"
                  target="_blank"
                  rel="noopener noreferrer"
