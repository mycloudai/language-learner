...
const internationalExam: DictionaryResource[] = [
  ...
  },
  {
    id: 'IELTS-oral-900',
    name: '雅思口语 900 beta版',
    description: '雅思口语 900 句, 需在 MyCloudAI 设置中调小英语字体',
    category: '国际考试',
    tags: ['IELTS'],
 ...
 */
const rawDictionaryResources: DictionaryResource[] = [
  ...chinaExam,
  ...internationalExam,
  ...childrenEnglish,
  ...programming,
...
// Keep the first entry when duplicated IDs appear to avoid React key collisions.
function uniqueByDictionaryId(resources: DictionaryResource[]): DictionaryResource[] {
...
export const dictionaryResources: DictionaryResource[] = uniqueByDictionaryId(rawDictionaryResources)
