...
不需要担心自己的 pr 没有完整的覆盖掉所有 corner case 或者是否会与项目的其他功能产生冲突（对于 new contributor 来说，很难有时间完整理解项目所有代码和逻辑，so take easy ❤️），只需要尽自己所能去实现，我们会在 review 的过程中一起讨论和完善。 我们都贡献自己擅长的部分就可以打造一个优秀 pr 和更好的 MyCloudAI！
