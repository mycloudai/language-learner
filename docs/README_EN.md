<div align=center>
  <img src="https://github.com/Kaiyiwing/mycloudai-learner/blob/master/src/assets/logo.svg"/>
</div>
...
<p align="center">
  <a href="https://github.com/Kaiyiwing/mycloudai-learner/blob/master/LICENSE">
    <img src="https://img.shields.io/github/license/KaiyiWing/mycloudai-learner" alt="License">
  </a>
  <a>
    <img src="https://travis-ci.com/Kaiyiwing/mycloudai-learner.svg?branch=master" alt="Build State">
  </a>
  <a>
...
- Vercel: <https://www.mycloudai.org/language-learner/>, or <https://mycloudai-learner.vercel.app/>.
...
MyCloudAI Learner also has a Visual Studio Code plugin. With a single click and you will be able to practice anytime.

- Plugin: [VSCode Plugin Market](https://marketplace.visualstudio.com/items?itemName=Kaiyi.mycloudai-learner)
- Project: [GitHub](https://github.com/Kaiyiwing/mycloudai-learner-vscode)

## ✨ Design Goals

MyCloudAI Learner is designed for people who type English in their daily work and English is not their mother tongue. It is common for them to type faster in their native language than in English. This is mainly because they have built a strong [muscle memory][mm] in their years of experience of typing in native languages. Their muscle memory of English words and phrases is relatively weak. Therefore, people tend to “forget the words” when typing in English.

In order to consolidate English typing skills, you have to keep memorizing words. MyCloudAI Learner combines vocabulary memorization with typing practice, so you can consolidate muscle memory while reciting words.
...
MyCloudAI Learner has many built-in dictionaries (word banks) for different purposes (examination, learning, and grading). Besides, it also provides dictionaries for developers learning APIs and common words and phrases used by programming languages and libraries.
...
While typing, MyCloudAI Learner shows the [IPA][ipa] of current word and reads the word. This helps people memorize pronunciation and spelling together.

[ipa]: https://en.wikipedia.org/wiki/International_Phonetic_Alphabet

### Dictation Mode

After people finish a chapter, MyCloudAI Learner will ask if people are willing to dictate the chapter. This is intended to consolidate words learned in the chapter.

<div align=center>
  <img src="https://github.com/Kaiyiwing/mycloudai-learner/blob/master/docs/phonetic.jpeg"/>
</div>

### Speed and Accuracy

MyCloudAI Learner counts how many strokes people have typed and shows the speed and accuracy in real time. By doing so, people can acknowledge how much they have improved.

<div align=center>
  <img src="https://github.com/Kaiyiwing/mycloudai-learner/blob/master/docs/dictation.png"/>
</div>
...
If you want to contribute your own API thesaurus, please have a look at [issue #40](https://github.com/Kaiyiwing/mycloudai-learner/issues/40) and [PR #67][67] in order to learn how to contribute.

[67]: https://github.com/Kaiyiwing/mycloudai-learner/pull/67
...
The current progress and future plans are described in [this issue][issue-42]. The issue also contains comments on suggestions and developing features. If you are interested in the future of MyCloudAI Learner, feel free to join the discussion.

If you like the idea of MyCloudAI Learner, please feel free to submit PRs. We would be grateful for your contributions.

[issue-42]: https://github.com/Kaiyiwing/mycloudai-learner/issues/42
...
Currently, MyCloudAI Learner is mainly maintained by three people in their spare time. In the future, we hope to purchase a separate domain and host an backend server for data synchronization. Therefore, if you like MyCloudAI Learner, please consider donation. This will definitely motivate us on the way of making MyCloudAI Learner better!

<img src="https://github.com/Kaiyiwing/mycloudai-learner/blob/master/docs/alipay.png" width="200px"/>

Note: we only accept donation from Alipay at present.

## 👨‍💻 Contributors

<a href="https://github.com/Kaiyiwing/mycloudai-learner/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=Kaiyiwing/mycloudai-learner" />
</a>
...
[![Stargazers over time](https://starchart.cc/Kaiyiwing/mycloudai-learner.svg)](https://starchart.cc/Kaiyiwing/mycloudai-learner)
