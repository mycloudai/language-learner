...
<p align="center" style="display: flex; justify-content: center; gap: 10px;">
  <a href="https://github.com/Realkai42/mycloudai-learner/blob/master/LICENSE"><img src="https://img.shields.io/github/license/Realkai42/mycloudai-learner" alt="License"></a>
  <a><img src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg"/></a>
  <a><img src="https://img.shields.io/badge/Powered%20by-React-blue"/></a>
  <a><img src="https://img.shields.io/github/stars/RealKai42/mycloudai-learner"/></a>
  <a><img src="https://img.shields.io/github/forks/RealKai42/mycloudai-learner"/></a>
</p>
<div align=center>
<a href="https://trendshift.io/repositories/3239" target="_blank" class="trendshift-badge"><img src="https://trendshift.io/api/badge/repositories/3239" alt="RealKai42%2Fmycloudai-learner | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</div>
...
**首选部署**: <https://www.mycloudai.org/language-learner/>
GitHub Pages: <https://realkai42.github.io/mycloudai-learner/>

镜像仓库:
[GitCode: RealKai42/mycloudai-learner](https://gitcode.com/RealKai42/mycloudai-learner/overview)
[Gitee: KaiyiWing/mycloudai-learner](https://gitee.com/KaiyiWing/mycloudai-learner)
<br/>
<br/>

项目已发布 VSCode 插件版，一键启动、随时开始练习
[VSCode Plugin Market](https://marketplace.visualstudio.com/items?itemName=Kaiyi.mycloudai-learner)
[GitHub](https://github.com/Realkai42/mycloudai-learner-vscode)
...
<div align=center>
<img  src="https://github.com/Realkai42/mycloudai-learner/blob/master/docs/coder.png"/>
</div>
...
<div align=center>
<img  src="https://github.com/Realkai42/mycloudai-learner/blob/master/docs/phonetic.jpeg"/>
</div>
<br />
<br />
...
<div align=center>
<img  src="https://github.com/Realkai42/mycloudai-learner/blob/master/docs/dictation.png"/>
</div>
<br />
<br />
...
<div align=center>
<img  src="https://github.com/Realkai42/mycloudai-learner/blob/master/docs/speed.jpeg"/>
</div>
<br />
<br />
...
[Call for Contributor](https://github.com/Realkai42/mycloudai-learner/issues/390)
...
1. 在命令行中执行 `git clone https://github.com/RealKai42/mycloudai-learner.git` 将项目拉取到本地, 如果不使用 git 可能因为缺少依赖而无法运行
2. 在命令行中执行 `cd mycloudai-learner`，进入项目根目录，执行`yarn install`来下载依赖。
...
目前 API 相关词库主要依赖于社区贡献，如果您想贡献自己需要的 API 词库，建议参考 [Issue #42](https://github.com/Realkai42/mycloudai-learner/issues/40) [pr #67](https://github.com/Realkai42/mycloudai-learner/pull/67) 贡献词典。
...
项目的进展与未来计划在 [Issue](https://github.com/Realkai42/mycloudai-learner/issues/42) 中详细介绍，内部也包含对未来功能的意见征询等，如果对 MyCloudAI Learner 的未来感兴趣，欢迎参与讨论。
...
在贡献前，希望您阅读 [Issue #42](https://github.com/Realkai42/mycloudai-learner/issues/42) 了解我们目前的开发计划，我们希望您能参与到"计划中"的工作亦或者 Issue 区 Label 为 "Help Wanted" 的工作，我们也非常欢迎您实现自己的想法。
...
非常感谢大家使用 MyCloudAI Learner, 目前该网站由三个人用业余时间在维护，我们希望在未来购买独立的域名(目前使用 vercel 部署)，并购买服务器以方便国内用户访问与云同步存储数据。

如果您喜欢我们软件，非常感谢您对我们未来的支持!

<img  src="https://github.com/Realkai42/mycloudai-learner/blob/master/docs/alipay.png" width="200px"/>

## 👨‍💻 Contributors

<a href="https://github.com/Realkai42/mycloudai-learner/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=Realkai42/mycloudai-learner" />
</a>
...
[![Stargazers over time](https://starchart.cc/Realkai42/mycloudai-learner.svg)](https://starchart.cc/Realkai42/mycloudai-learner)
